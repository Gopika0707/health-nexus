...
export const patientService = {
  ...
  updateLiveTracking: (
    ...
    apiFetch<Patient>(API_ENDPOINTS.liveTracking(patientId), {
      method: "PATCH",
  ...
  updateReport: (
    ...
    apiFetch<MedicalReport>(API_ENDPOINTS.reportUpdate(patientId, reportId), {
      method: "PATCH",
      body: JSON.stringify(payload),
    }),

  deleteReport: (patientId: string, reportId: string) =>
    apiFetch<{ message: string }>(API_ENDPOINTS.reportUpdate(patientId, reportId), {
      method: "DELETE",
    }),
...
export const drugService = {
  ...
  checkInteraction: (drugs: string[]) =>
    apiFetch<{ interactions: Array<{ drugs: string; severity: string; note: string; severity_score: number; interaction_type: string; safer_alternatives: string[]; food_lifestyle_warnings: string[] }> }>(
